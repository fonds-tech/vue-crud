...
import { Mitt, clone, merge, isArray, isFunction } from "@fonds/utils"
import { ref, inject, provide, reactive, defineComponent, getCurrentInstance } from "vue"
...
function useHelper({ config, crud, mitt }: HelperOptions) {
  // 刷新随机值，避免脏数据
