...
const upsert = useUpsert({
  ...
  items: [
    ...
    { prop: "name", label: "姓名", component: { is: "el-input", props: { placeholder: "请输入姓名" } }, rules: [{ required: true, message: "请填写姓名" }] },
    { prop: "account", label: "账号", component: { is: "el-input", props: { placeholder: "请输入账号" } } },
    { prop: "priority", label: "优先级", component: { is: "el-select", props: { placeholder: "请选择优先级" }, options: priorityDict } },
    { prop: "progress", label: "进度", component: { is: "el-slider", props: { min: 0, max: 100, showStops: true } } },
    ...
    { prop: "remark", label: "备注", span: 2, component: { is: "el-input", props: { type: "textarea", rows: 3, maxlength: 100, showWordLimit: true } } },
  ],
  actions: [
    { type: "cancel" },
    {
